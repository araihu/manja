...
func TestKubernetesCatalog(t *testing.T) {
	...
	for _, want := range []string{`id="catalog-search-dialog"`, `data-search-child-base="/catalogs/kubernetes/snapshots/`, `src="/manja-assets/catalog-search.js"`, `data-catalog-overview="true"`, `id="darkModeToggleBtn"`} {
