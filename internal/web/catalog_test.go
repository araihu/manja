...
func TestCatalogAssetsServeClientSearchRouter(t *testing.T) {
	...
	for _, contract := range []string{"crypto.subtle.digest", "Browser index", "Server fallback", "manja.catalog.recent.v1", "escapeHTML", "search-highlight", "highlight", "usesCommandShortcut", "Command K", "Ctrl K", "ManjaLocalDocsEnhancer", "closeSearch(false)", "bindCatalogSidebarScrollPreservation", "pendingSidebarScrollTop"} {
...
func TestCatalogAssetsServeDeterministicLocalDocsWasmRuntime(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			length:      15_814_221,
			digest:      "6f923aea52d43129fefff1d5cc993b9543660381b4f223ed30338544b898c118",
		...
		},
		{
			...
			length:   2_816_672,
			digest:   "936ce14086bbc068dbac56be866eada7fd42a5a840d5e479b2ac5bd741370761",
		},
	} {
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
