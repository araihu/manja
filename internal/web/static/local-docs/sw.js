...
(function (root, factory) {
  ...
  function validateDescriptor(input, origin) {
    ...
    if (input.static !== undefined && (!input.static || input.static.htmlOnly !== undefined && typeof input.static.htmlOnly !== "boolean" || !validBase(input.static.deploymentBase, origin) || input.publicationBase.indexOf(input.static.deploymentBase) !== 0 || input.static.workerUrl !== input.static.deploymentBase + "sw.js" || input.static.workerScope !== input.static.deploymentBase || input.static.offlineShellUrl !== input.publicationBase + "_manja/offline-shell/" || input.static.exportManifestUrl !== input.static.deploymentBase + "_manja/export.json")) fail("descriptor static route is invalid")
