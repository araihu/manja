...
func TestPreparedSchemaNodeShardOwnsImmutableNodes(t *testing.T) {
	...
	node := projection.SchemaNode{Ordinal: 7, ID: "node", Name: "Node", Type: "object", Description: strings.Repeat("x", 8192), Enum: []string{"value"}, Constraints: []projection.SchemaConstraint{{Name: "maxLength", Value: "4"}}, Properties: []projection.SchemaNodeProperty{{Ordinal: 0, ID: "property", Name: "child", SchemaRef: 8}}, Items: []projection.SchemaNodeItem{{Ordinal: 0, ID: "item", SchemaRef: 8}}}
	...
	if prepared.RetainedBytes() < 2*8192 {
		t.Fatal("decoded string storage was not charged")
	}
