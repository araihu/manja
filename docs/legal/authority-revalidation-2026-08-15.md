...
| Arai Hû Assets | `https://github.com/araihu/assets` / `origin/main` `9a1fce17ad1a99892e81bf3b3b36e7ed48448b63` / `2be5242f515b452052e514c8dd495a95791e5925`; consumed release `v0.2.1` `fdfb1c2aad8fa61779e7b8c6f208e52a6cf825ce` / `e89dce3f6bbb129bf3dfd3f04d874cdb220bb4a0` | Four manifest-selected source paths and all installed Manja destinations are bound by [`external-source-provenance.json`](external-source-provenance.json), with the archive SHA-256 `818a32246c040871c8f28bb085269b6b9f21c579b18dc4c3c1f20d70716eaf70`. The same receipt records `LICENSE` (11,358 bytes, blob `d645695673349e3947e8e5ae42332d0ac3164cd7`, SHA-256 `cfc7749b96f63bd31c3c42b5c471bf756814053e847c10f3eb003417bc523d30`, Apache-2.0) and `NOTICE` (633 bytes, blob `61949028cb73348c69d488a844a36fb6253b46b7`, SHA-256 `8ab9628587c91891e424abdc1c16fdd8d9a89191e56fe496dadc979994bd6366`). | Mechanical source and legal-file identity is recorded. Final artifact notice placement, first-party authority, Arai Hû attribution, and trademark/endorsement clearance remain **BLOCKED**. |
| Goshtoso Go module | `https://github.com/araihu/goshtoso` / `origin/main` `78921015c2f3b46379ac30d3d9f80755bb860307` / `87d6cac8b9aa732b27976c32851d28fd430475af`; consumed module `v0.1.13` `19c86f1dbbcf5a85c55f2d9b3bfaac4fd5febea6` / `49c9f5557ae5bb74a8f333af8958bbf495377af0` | The pinned module and `LICENSE` are bound by [`external-source-provenance.json`](external-source-provenance.json); the license is 1,078 bytes, blob `0a7743398ecbeacc05ed822e1f74023ee9b36842`, SHA-256 `cacf68ff9920c026f5de2ebf992333c1a243e45d81aaa5b4577e05b52c5a9584` (MIT). | Mechanical module/license identity is recorded. Runtime dependency inventory, final artifact notices, first-party authority, and any mark/trademark clearance remain **BLOCKED**. |
